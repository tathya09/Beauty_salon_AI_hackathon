...
const SALONS = [
  ...
  },
  {
    ...
    tags: ['nails', 'gel-nails', 'nail-art', 'manicure'],
    ...
    services: [
      ...
      { id: 'svc-004-2', name: 'Nail Art (per nail)', category: 'nails' as const, duration: 60, price: 600, description: 'Custom nail art designs' },
      { id: 'svc-004-3', name: 'Pedicure', category: 'nails' as const, duration: 45, price: 700, description: 'Relaxing foot pedicure' },
    ],
  },
  {
  ...
  },
  {
    ...
    tags: ['waxing', 'threading', 'cleanup', 'manicure'],
    ...
    services: [
      ...
      { id: 'svc-010-3', name: 'Basic Manicure', category: 'nails' as const, duration: 30, price: 250, description: 'Classic manicure' },
    ],
  },
]
